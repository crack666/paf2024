...
class TaskQueueTest {
    ...
    void shouldEnqueueAndDequeueTask() {
        ...
        Task task1 = new Task(1, "Task 1", "Description 1", LocalDateTime.now().plusDays(1), null, "de.vfh.paf.tasklist.domain.tasks.CalculatePiTask");
        Task task2 = new Task(2, "Task 2", "Description 2", LocalDateTime.now().plusDays(1), null, "de.vfh.paf.tasklist.domain.tasks.CalculatePiTask");
